...
\begin{description}
\item[Exorcism] You gain the ability to turn undead three times per day as a good-aligned cleric of the same level as the class that granted you this sphere. You cannot use these turning attempts to power divine feats.

\begin{description*}
\item[1] Protection from Evil
\item[3] Consecrate
\item[5] Magic Circle against Evil
\item[7] Dispel Evil
\item[9] Disrupting Weapon
\item[11] Banishment
\item[13] Holy Word
\item[15] Sunburst
\item[17] Undeath's Eternal Foe (SpC)
\item[19] Freedom
\end{description*}
