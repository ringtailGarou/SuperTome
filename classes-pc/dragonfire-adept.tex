...
\levelfive{Blast Breath, Dragoncraft, Draconic Spirit & 6d6}
...
\leveltwelve{Scales II, Sphere Access & 15d6}
\levelthirteen{Concussive Breath & 16d6}
\levelfourteen{Shadow Breath & 18d6}
...
\item \textbf{Frightful Presence:} You gain the Frightful Presence special ability, effective whenever you attack with a natural weapon, fly overhead, or use your breath weapon. All creatures within range with HD less than your own must make a Will save (DC 10+1/2 level+Charisma Mod) or be \linkcondition{Shaken} for 4d6 rounds. If their HD is more than 4 less than your own they are \linkcondition{Panicked} for 4d6 rounds instead. Creatures that make their save are immune to your Frightful Presence for 24 hours. Naturally, other creatures with a Frightful Presence ability are immune to this, and you are immune to their Frightful Presence. This is a [Mind-Affecting], [Fear] effect. At level three the range is 100ft, At level nine the range is 200ft, and at level fifteen the range becomes 300ft.
