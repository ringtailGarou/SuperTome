...
\classentry{Monk}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tagline{"I am a Grand Master of Flowers. You are not."}
...
\begin{classtable}
\levelone{Armored in Life, Fatal Strike, Willow Step, Fighting Style}
\leveltwo{Rain of Flowers, Abundant Leap}
\levelthree{Fighting Style}
\levelfour{Diamond Soul}
\levelfive{Fighting Style}
\levelsix{Walk of a Thousand Steps}
\levelseven{Fighting Style}
\leveleight{Immaculate Diamond Soul}
\levelnine{Master Fighting Style}
\levelten{Leap of the Clouds}
\leveleleven{Master Fighting Style}
\leveltwelve{Master of the Four Winds}
\levelthirteen{Master Fighting Style}
\levelfourteen{Master of the Four Seasons}
\levelfifteen{Grand Master Fighting Style}
\levelsixteen{Master of Diamond Soul}
\levelseventeen{Grand Master Fighting Style}
\leveleighteen{Perfect Mastery}
\levelnineteen{Grand Master Fighting Style}
\leveltwenty{Grand Master of Flowers}
\end{classtable}
...
\item While Active, your Fighting Style forces any opponent struck by your slam attack to make a Fortitude Save (DC 10 + \sfrac{1}{2} your character level + your Wisdom Modifier) or become \textit{stunned} for one round.
...
\item While Active, your Master Fighting Style affects any creature struck with your slam attack with a \textit{banishment} effect that transports it back to its home plane unless it succeeds at a Will save (DC 10 + \sfrac{1}{2} character level + Wisdom Modifier). Outsiders suffer a -4 penalty to their saving throw. A creature so banished, may not return to the plane it was banished from for a year.
\item While Active, your Master Fighting Style forces any creature struck by your slam attack to make a Reflex Save (DC 10 + \sfrac{1}{2} character level + Wisdom Modifier) or be \textit{helpless} for one round.
...
\item While Active, your Master Fighting Style forces every creature within 10 feet of you to make a Will save (DC 10 + \sfrac{1}{2} character level + Wisdom Modifier) or become \textit{panicked} for one minute.
...
\item While Active, your Grand Master Fighting Style forces every creature struck with your slam attack to make a Fortitude save (DC 10 + \sfrac{1}{2} character level + Wisdom Modifier) or die.
\item While Active, your Grand Master Fighting Style affects any target you strike with your slam attack with a \textit{disintegrate} effect, with a caster level equal to your character level (DC 10 + \sfrac{1}{2} character level + Wisdom Modifier).
...
\item While Active, your Grand Master Fighting Style forces any opponent you strike with your slam attack to make a Willpower save (DC 10 + \sfrac{1}{2} character level + Wisdom Modifier) or become \textit{feeble minded}.
