...
\newcommand{\goodfort}{\renewcommand{\fort}{\empty}}
\newcommand{\poorfort}{\renewcommand{\fort}{a}}
...
\newcommand{\goodwill}{\renewcommand{\will}{\empty}}
\newcommand{\poorwill}{\renewcommand{\will}{a}}
...
\newenvironment{minorcastingclasstable}[1]
{
\begin{table}[htb]
\rowcolors{1}{offyellow}{white}
\caption{#1}
\centering
\begin{tabular}{l *{4}{c} l *{7}{c}}
\multicolumn{6}{c}{\cellcolor{white}} & \multicolumn{7}{c}{\cellcolor{white} \textbf{Spells Per Day}}\\
\textbf{Level} & \textbf{BAB} & \textbf{Fort} & \textbf{Reflex} & \textbf{Will} & \textbf{Special} & \textbf{0}&\textbf{1}&\textbf{2}&\textbf{3}&\textbf{4}&\textbf{5}&\textbf{6}\\
}{
\end{tabular}
\end{table}
}
...
\newenvironment{fullcastingclasstable}[1]
{
\begin{table}[htb]
\rowcolors{1}{offyellow}{white}
\caption{#1}
\centering
\begin{tabular}{l *{4}{c} l *{10}{c}}
\multicolumn{6}{c}{\cellcolor{white}} & \multicolumn{10}{c}{\cellcolor{white}\textbf{Spells Per Day}}\\
\textbf{Level} & \textbf{BAB} & \textbf{Fort} & \textbf{Reflex} & \textbf{Will} & \textbf{Special}& \textbf{0}&\textbf{1}&\textbf{2}&\textbf{3}&\textbf{4}&\textbf{5}&\textbf{6}&\textbf{7}&\textbf{8}&\textbf{9}\\
}{
\end{tabular}
\end{table}
}
