...
\item[Armor Check Penalty (ACP)] This penalty applies to all \linkskill{Balance}, \linkskill{Climb}, \linkskill{Escape Artist}, \linkskill{Jump}, \linkskill{Sleight of Hand}, and \linkskill{Tumble} checks that you make. Twice this applies to all \linkskill{Swim} checks that you make.
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Armor and Shield Descriptions}
%%%%%%%%%%%%%%%%%%%%%%%%%
